...
public class solution {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int bl;  // инициализация переменной для вычисления остатка распределяемого в "левой" по отношению к "к"-тому элементу части массива
            int br;  // инициализация переменной для вычисления остатка распределяемого в "правой" по отношению к "к"-тому элементу части массива
